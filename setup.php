...
if ($db_ok) {
    $esperadas = ['usuarios', 'estabelecimentos', 'produtos', 'produto_aliases', 'notas', 'itens', 'loja_pdvs', 'loja_itens', 'vendas', 'venda_itens', 'custos_parametros', 'custos_pdv', 'sync_estado'];
